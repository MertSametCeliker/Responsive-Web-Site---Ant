...
<head>
	<meta charset="UTF-8">
	<title>Ant İzmir Disleksi İletişim</title>
        ...
        <div class="mdp-map">
				...
				if ( $query->rowCount() ){
					while ($row = $query->fetch(PDO::FETCH_ASSOC)) {
						echo   "<iframe src='".$row["harita_linki"]."' width='100%' height='600' frameborder='0' scrolling='no' marginheight='0' marginwidth='0' '></iframe>";}}
				?>"
        </div><!--mdp-map end-->
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" name="name" class="name" placeholder="İsim Soyisim" required>
                                    </div><!--form-group end-->
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-submit">
                                        <button type="button" id="submit" class="btn-default">Şimdi Ulaşın <i class="fa fa-long-arrow-alt-right"></i></button>
                                    </div><!--form-submit end-->
                                </div>
                            </div>
                        </form>
